...
# --enable-cd true: activa un webhook de Continuous Deployment -- cuando ACR publica un tag
...
az webapp deployment container config -n docprocessor-lab-001 -g rg-appservice-lab --enable-cd true
